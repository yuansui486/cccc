    ...
    def test_spawn_daemon_uses_supervised_process_kwargs(self) -> None:
        ...
        try:
            with tempfile.TemporaryDirectory() as td:
                ...
                with patch.object(daemon_main, "resolve_background_python_argv", return_value=[r"D:\dev\cccc\.venv\Scripts\pythonw.exe", "-m", "no1.daemon_main", "run"]) as mock_argv, patch.object(daemon_main, "supervised_process_popen_kwargs", return_value={"creationflags": 0x208}), patch.object(
                ...
                mock_argv.assert_called_once_with([daemon_main.sys.executable, "-m", "no1.daemon_main", "run"])
