...
INSTALL_CAPABILITY_RECORD = {
    ...
    "capsule_text": (
        ...
        "4. For GitHub repositories, remote SKILL.md URLs, and local SKILL.md files/directories, install the minimal matching OneColleague capability records through cccc_capability_install. "
        ...
        "- Generic URLs and local paths must go through cccc_capability_install and become OneColleague capability records; report unsupported only when the install operation rejects the target.\n"
