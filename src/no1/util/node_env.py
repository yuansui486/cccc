...
def with_node_deprecation_warnings_suppressed(env: Mapping[str, Any] | None = None) -> dict[str, str]:
    ...
    OneColleague often launches Node-based runtimes, MCP servers, and Playwright drivers. Under newer Node
    releases, dependencies may emit DEP0169 (`url.parse()`) warnings to stderr even though OneColleague
