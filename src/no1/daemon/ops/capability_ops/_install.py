...
def _github_headers() -> Dict[str, str]:
    headers = {
        "User-Agent": "onecolleague-capability-sync/1.0",
...
def _build_synthetic_tool_name(capability_id: str, real_tool_name: str, *, used: set[str]) -> str:
    ...
    base = f"onecolleague_ext_{cap_hash}_{_sanitize_tool_token(real_tool_name)}"
    name = base
    i = 2
    while name in used:
        name = f"{base}_{i}"
...
def _remote_mcp_call(url: str, method: str, params: Dict[str, Any], *, timeout_s: float) -> Dict[str, Any]:
    init_req = {
        ...
        "params": {
            ...
            "capabilities": {},
            "clientInfo": {"name": "onecolleague-capability-runtime", "version": "1.0"},
        },
    }
