    ...
    try:
        ...
        out: Dict[str, Any] = {
            ...
            "daemon": {
                ...
                "version": __version__,
                "ts": utc_now_iso(),
                "log_path": str(home / "daemon" / "onecolleagued.log"),
            },
...
def _debug_component_path(*, component: str, group_id: str) -> tuple[Optional[Path], Optional[DaemonResponse]]:
    home = ensure_home()
    if component in ("daemon", "onecolleagued"):
        return home / "daemon" / "onecolleagued.log", None
    ...
    if component in ("web",):
        return home / "daemon" / "onecolleague-web.log", None
