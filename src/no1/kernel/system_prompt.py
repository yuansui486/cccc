...
def render_role_system_prompt(
    *,
    ...
    # Keep this stable and short. OneColleague route details belong in onecolleague_help.
    visible_reply_line = "- Use onecolleague_message_reply for replies; use onecolleague_message_send for new messages."

    core_lines = [
        "OneColleague Protocol:",
        visible_reply_line,
...
def render_system_prompt(*, group: Group, actor: Dict[str, Any]) -> str:
    ...
    - Protocol reference lives in MCP: see onecolleague_help
    """
