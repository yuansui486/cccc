...
3. Do not answer from fuzzy memory. If current status, next step, or blocker is not grounded in fresh context, use MCP tool `onecolleague_bootstrap`, follow `memory_recall_gate`, and open `onecolleague_help` before replying.
