...
def evaluate_agent_state_hygiene(
    *,
    ...
    return {
        ...
        "update_command": (
            'onecolleague_agent_state(action="update", actor_id="<self>", focus="...", next_action="...", '
            'what_changed="...", environment_summary="...", user_model="...", persona_notes="...")'
        ),
        "execution_update_command": (
            'onecolleague_agent_state(action="update", actor_id="<self>", focus="...", next_action="...", what_changed="...")'
        ),
        "mind_context_update_command": (
            'onecolleague_agent_state(action="update", actor_id="<self>", environment_summary="...", '
