...
KNOWN_RUNTIMES: Dict[str, Dict[str, Any]] = {
    ...
    "hermes": {
        ...
        "mcp_add_pattern": "onecolleague runtime hermes prepare --yes",
    },
    "kimi": {
...
def get_onecolleague_mcp_stdio_command() -> List[str]:
    ...
    try:
        ...
        # console scripts such as `onecolleague` live in the unresolved venv bin directory.
    ...
    for candidate in candidates:
        ...
        seen.add(resolved)
        return [resolved, "mcp"]
    return [sys.executable, "-m", "no1.ports.mcp.main"]
