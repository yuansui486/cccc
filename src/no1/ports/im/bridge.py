"""
OneColleague IM Bridge - Core logic.
        ...
        *,
        ...
        while args:
            ...
            if head.startswith("@") or head in ("user",):
                # Only consume tokens that are known OneColleague actors/selectors.
...
def start_bridge(group_id: str, platform: str = "telegram") -> None:
    ...
    if not im_config:
        ...
        print("Run: onecolleague im set telegram --group " + group_id)
        sys.exit(1)
...
# Entry point for running as module: python -m no1.ports.im.bridge <group_id> [platform]
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python -m no1.ports.im.bridge <group_id> [platform]")
