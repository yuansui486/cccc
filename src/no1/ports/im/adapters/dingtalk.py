"""
DingTalk adapter for OneColleague IM Bridge.
...
class DingTalkAdapter(IMAdapter):
    ...
    def _start_stream_listener(self) -> None:
        ...
        def stream_loop():
            ...
            class OneColleagueChatbotHandler(dingtalk_stream.ChatbotHandler):
    ...
    def _upload_media(self, raw: bytes, filename: str, media_type: str = "file") -> Optional[str]:
        ...
        boundary = "----onecolleague" + uuid.uuid4().hex
