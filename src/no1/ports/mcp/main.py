...
def handle_request(req: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if method == "tools/call":
        ...
        try:
            ...
            if (
                canonical_tool_name
                in {"onecolleague_capability_enable", "onecolleague_capability_import", "onecolleague_capability_install", "onecolleague_capability_uninstall", "onecolleague_capability_use"}
