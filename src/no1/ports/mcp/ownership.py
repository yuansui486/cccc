...
_PACK_OWNER_BY_TOOL = {
    ...
    "onecolleague_project_info": "pack:context-advanced",
    "onecolleague_tracked_send": "pack:context-advanced",
    "onecolleague_context_sync": "pack:context-advanced",
    "onecolleague_memory": "pack:context-advanced",
    ...
    "onecolleague_repo": "pack:diagnostics",
    "onecolleague_presentation": "pack:diagnostics",
    "onecolleague_terminal": "pack:diagnostics",
    "onecolleague_debug": "pack:diagnostics",
    "onecolleague_capability_state": "pack:capability-admin",
    "onecolleague_capability_enable": "pack:capability-admin",
    "onecolleague_capability_install": "pack:capability-admin",
