# OneColleague v0.4.6 Release Notes
...
This makes `v0.4.6` a stronger operational release than `v0.4.5`, especially if you are running OneColleague on Windows or frequently exercising stop/start/restart flows.
