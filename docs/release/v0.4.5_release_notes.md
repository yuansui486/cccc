# OneColleague v0.4.5 Release Notes
...
- supervised Web restart/apply flows are clearer from the main `onecolleague` session
...
- Windows Codex MCP setup is more robust and now prefers a stable absolute `onecolleague` entrypoint instead of trusting weaker path assumptions
