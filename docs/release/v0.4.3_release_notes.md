# OneColleague v0.4.3 Release Notes
...
- live runtime guidance now belongs to `onecolleague_help`, so optional capability-specific instructions appear only when actually relevant
...
- the officially supported runtime surface was narrowed and clarified to the runtimes OneColleague can set up and operate reliably
